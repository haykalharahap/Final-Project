          ...
          <div className="space-y-3 sm:space-y-4">
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="relative block w-full rounded-md border-0 py-2.5 sm:py-1.5 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-orange-600 text-sm leading-6"
            ...
            <div>
              <label htmlFor="email-address" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Email address</label>
              <input
                id="email-address"
                name="email"
                type="email"
            ...
            <div>
              <label htmlFor="phoneNumber" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Phone Number</label>
              <input
                id="phoneNumber"
                name="phoneNumber"
                type="tel"
            ...
            <div>
              <label htmlFor="profilePictureUrl" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Profile Picture URL <span className="text-gray-400">(optional)</span></label>
              <input
            ...
            <div>
              <label htmlFor="passwordRepeat" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Confirm Password</label>
              <input
                id="passwordRepeat"
                name="passwordRepeat"
                type="password"
