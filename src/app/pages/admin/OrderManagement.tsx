        ...
        <div className="space-y-4 sm:space-y-6">
            ...
            <div className="md:hidden space-y-3">
                {filteredTransactions.length === 0 ? (
                    ...
                    filteredTransactions.map((trx) => (
                        <div key={trx.id} className="bg-white rounded-lg border shadow-sm p-4 space-y-3">
                            <div className="flex justify-between items-start">
                                <div>
                                    <p className="font-bold text-gray-800 text-sm">{trx.invoiceId || trx.id.slice(0, 8)}</p>
                                    <p className="text-xs text-gray-500">{new Date(trx.orderDate || trx.createdAt).toLocaleDateString('id-ID')}</p>
                                </div>
